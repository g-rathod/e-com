using DouendeEF;
using DouendeEF.Pages.Admin.ApiScopes;
using DouendeEF.Pages.Admin.Clients;
using DouendeEF.Pages.Admin.IdentityScopes;
    ...
    internal static class HostingExtensions
    {
        public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            // this adds the necessary config for the simple admin/config pages
            {
                ...
                builder.Services.AddTransient<DouendeEF.Pages.Portal.ClientRepository>();
